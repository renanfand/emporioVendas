...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { description: @announcement.description, price: @announcement.price, title: @announcement.title, viewn: @announcement.viewn } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { description: @announcement.description, price: @announcement.price, title: @announcement.title, viewn: @announcement.viewn } }
